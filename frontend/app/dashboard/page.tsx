    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white p-8">
      ...
      <nav className="mb-8 rounded-xl border border-slate-700/60 bg-slate-900/40 p-4" aria-label="Operações">
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            <OpsLink href="/dashboard/anotacoes">Anotações</OpsLink>
            <OpsLink href="/dashboard/followups">Follow-ups</OpsLink>
            <OpsLink href="/dashboard/protocolos">Protocolos</OpsLink>
